...
"""
This module contains configuration classes for the training pipeline of the network security project.
It includes classes for the training pipeline configuration, data ingestion configuration, and data validation configuration.
"""
